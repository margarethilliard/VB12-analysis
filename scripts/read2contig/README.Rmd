...
bash read2contig_paths.sh ## make sure you've modified file paths read2contig_paths.sh first!!

## STEP 4: generate tmp directories -- helpful to use a screen if possible 
## practice command 
...
## STEP 5: copy your diamond output files and blast output files to new directories 
mkdir diamond_files blastouts
...
cd /share/lemaylab-backedup/mhilliard/FL100/read2contig
cp tmp_*/*.blastouts blastouts/

## STEP 6: copy over taxonomy_files directory and gen_read_taxonomy_file.R script 
cd /share/lemaylab-backedup/mhilliard/FL100/read2contig
cp -r /share/lemaylab/aoliver/sarah_gh/playground/read2contig/taxonomy_files .
cp /share/lemaylab/aoliver/sarah_gh/playground/read2contig/gen_read_taxonomy_file.R .

## STEP 7: load up singularity -- helpful to use a screen if possible 
screen -r read2contig_screen
module load /software/modules/1.923/lssc0-linux/modulefiles/singularity/3.6.3
singularity run -W /share/lemaylab/mhilliard/FL100/read2contig --bind /share/lemaylab/mhilliard/FL100/read2contig:/home/docker /share/lemaylab/aoliver/software/nutrition_tools.sif
