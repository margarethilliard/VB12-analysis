...
- output: database/deduped_B12_db_no_eukaryotes_modified_short_headers.faa
...
- input: database/deduped_B12_db_no_eukaryotes_modified_short_headers.fa
...
- usage: python 10_make_description_lookup_file.py
