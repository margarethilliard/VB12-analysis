...
#write_csv(regression_intake_high, "/Users/local-margaret/Downloads/regression_md_high_intake.csv")
...
#readr::write_csv(regression_intake_low, "/Users/local-margaret/Downloads/regression_md_low_intake.csv")

#---- Subset regression metadata based on supplement use ----
...
#readr::write_csv(regression_supp_yes, "/Users/local-margaret/Downloads/regression_md_yes_supps.csv")
...
#readr::write_csv(regression_supp_no, "/Users/local-margaret/Downloads/regression_md_no_supps.csv")

#---- Subset merged relative abundance table to include only TaxaHFE-engineered taxa ----

# Full data model
clades_to_keep_FD <- c("d__Bacteria|p__Firmicutes_A|c__Clostridia|o__Lachnospirales|f__Lachnospiraceae|g__AM51-8",
                    ...
                    "d__Bacteria|p__Firmicutes_A|c__Clostridia|o__Lachnospirales|f__Lachnospiraceae|g__Coprococcus|s__Coprococcus_eutactus_A",
                    "d__Bacteria|p__Firmicutes_A|c__Clostridia|o__Lachnospirales|f__Lachnospiraceae|g__Butyribacter",
                    ...
                    "d__Bacteria|p__Firmicutes_A|c__Clostridia|o__Lachnospirales|f__Lachnospiraceae|g__UMGS1375")

# No supplement subset model
clades_to_keep_NS <- c("d__Bacteria|p__Firmicutes_A|c__Clostridia|o__Lachnospirales|f__Lachnospiraceae|g__AM51-8",
                    "d__Bacteria|p__Firmicutes_A|c__Clostridia|o__Lachnospirales|f__Lachnospiraceae|g__CAG-317",
                    "d__Bacteria|p__Firmicutes_A|c__Clostridia|o__Lachnospirales|f__Lachnospiraceae|g__Blautia_A|s__Blautia_A_faecis",
                    "d__Bacteria|p__Firmicutes_A|c__Clostridia|o__Lachnospirales|f__Lachnospiraceae|g__Mediterraneibacter|s__Mediterraneibacter_lactaris",
                    ...
                    "d__Bacteria|p__Firmicutes_A|c__Clostridia|o__Lachnospirales|f__Lachnospiraceae|g__Eisenbergiella",
...
# Supplement use subset model
clades_to_keep_S <- c("d__Bacteria|p__Firmicutes|c__Bacilli|o__Lactobacillales|f__Streptococcaceae|g__Streptococcus|s__Streptococcus_thermophilus",
...
clades_to_keep_HI <- c("d__Bacteria|p__Firmicutes_A|c__Clostridia|o__TANB77|f__CAG-508|g__CAG-245|s__CAG-245_sp000435175",
...
clades_to_keep_LI <- c("d__Bacteria|p__Firmicutes_A|c__Clostridia|o__Lachnospirales|f__Lachnospiraceae|g__CAG-317",
                    "d__Bacteria|p__Firmicutes_A|c__Clostridia|o__Lachnospirales|f__Lachnospiraceae|g__AM51-8",
                    "d__Bacteria|p__Firmicutes_A|c__Clostridia|o__Oscillospirales|f__Ruminococcaceae|g__Negativibacillus|s__Negativibacillus_sp000435195",
                    "d__Bacteria|p__Firmicutes_A|c__Clostridia|o__Lachnospirales|f__Lachnospiraceae|g__Fusicatenibacter",
...
taxa_table_filtered_long_HI <- taxa_table_filtered_HI %>%
  pivot_longer(cols = -taxa, names_to = "subject_id", values_to = "abundance")

taxa_table_filtered_long_LI <- taxa_table_filtered_LI %>%
  pivot_longer(cols = -taxa, names_to = "subject_id", values_to = "abundance")
...
#readr::write_csv(regression_full_data_HFE, "/Users/local-margaret/Downloads/full_HFE.csv")

regression_high_intake_HFE <- left_join(regression_intake_high, taxa_table_transposed_HI, by = "subject_id") %>% drop_na()
#readr::write_csv(regression_high_intake_HFE, "/Users/local-margaret/Downloads/high_intake_HFE.csv")

regression_low_intake_HFE <- left_join(regression_intake_low, taxa_table_transposed_LI, by = "subject_id") %>% drop_na()
#readr::write_csv(regression_low_intake_HFE, "/Users/local-margaret/Downloads/low_intake_HFE.csv")

regression_supp_yes_HFE <- left_join(regression_supp_yes, taxa_table_transposed_S, by = "subject_id") %>% drop_na()
#readr::write_csv(regression_supp_yes_HFE, "/Users/local-margaret/Downloads/supp_use_HFE.csv")

regression_supp_no_HFE <- left_join(regression_supp_no, taxa_table_transposed_NS, by = "subject_id") %>% drop_na()
#readr::write_csv(regression_supp_no_HFE, "/Users/local-margaret/Downloads/no_supp_use_HFE.csv")
