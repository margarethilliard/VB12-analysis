...
#write_csv(regression_full_data, "/Users/local-margaret/Downloads/regression_md_full.csv")
...
regression_intake_high <- metadata_sub %>%
  ...
  dplyr::select(-c("intake_group"))
#readr::write_csv(regression_intake_high, "/Users/local-margaret/Downloads/regression_md_high_intake.csv")
...
#readr::write_csv(regression_supp_yes_HFE, "/Users/local-margaret/Downloads/yes_supp_use_HFE.csv")
