...
wd1 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/high_intake/pathways/acetate"
wd2 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/high_intake/pathways/propionate"
wd3 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/high_intake/pathways/butyrate"

# Low intake data sets 
wd4 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/low_intake/pathways/acetate"
wd5 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/low_intake/pathways/propionate"
wd6 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/low_intake/pathways/butyrate"

# Supplement user data sets 
wd7 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/supp_use/pathways/acetate"
wd8 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/supp_use/pathways/propionate"
wd9 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/supp_use/pathways/butyrate"

# No supplement use data sets 
wd10 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/no_supp_use/pathways/acetate"
wd11 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/no_supp_use/pathways/propionate"
wd12 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/no_supp_use/pathways/butyrate"
...
letters_df <- data.frame(model = names(letters$Letters),
...
combined_results_mae$model <- factor(combined_results_mae$model,
...
group_labels <- c("Low intake" = "Adequate intake",
                  "High intake" = "High intake")
...
plot_1_pwys <- ggplot(combined_results_mae, aes(x = forcats::fct_rev(factor(model)), y = mean_percent_change)) +
  ...
  geom_text(aes(label = letter, 
                y = 11.25), # adjust vertical position of the letters 
            size =5) +  
...
# High intake data sets
wd1 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/high_intake/microbiome/acetate"
wd2 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/high_intake/microbiome/propionate"
wd3 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/high_intake/microbiome/butyrate"

# Low intake data sets 
wd4 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/low_intake/microbiome/acetate"
wd5 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/low_intake/microbiome/propionate"
wd6 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/low_intake/microbiome/butyrate"

# Supplement user data sets 
wd7 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/supp_use/microbiome/acetate"
wd8 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/supp_use/microbiome/propionate"
wd9 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/supp_use/microbiome/butyrate"

# No supplement use data sets 
wd10 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/no_supp_use/microbiome/acetate"
wd11 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/no_supp_use/microbiome/propionate"
wd12 <- "/Users/local-margaret/Desktop/VB12-analysis/data/intake_subset_analyses/no_supp_use/microbiome/butyrate"
...
plot_1_taxa <- ggplot(combined_results_mae, aes(x = forcats::fct_rev(factor(model)), y = mean_percent_change)) +
  ...
  geom_errorbar(aes(ymin = mean_percent_change - se_percent_change,
                ...
                width = 0.2) +
  geom_text(aes(label = letter, 
                y = 6.25), # adjust vertical position
  ...
  theme(axis.text = element_text(colour = "black", size = 16),
    ...
    strip.background = element_blank(),
    axis.text.x = element_text(color = "black", size = 16)) +
  scale_y_continuous(breaks = seq(-12, 6, by = 2)) + 
  scale_y_continuous(breaks = seq(-12, 6, by = 2)) + 
  coord_flip() +
  geom_hline(yintercept = 0, color = "black", linewidth = 1)
...
combined_results_rsq_summary <- combined_results_rsq_summary %>%
  mutate(group = case_when(
    grepl("_low_intake_", model) ~ "Adequate intake",
    grepl("_high_intake_", model) ~ "High intake",
    grepl("_no_", model) ~ "No supplement use",
    TRUE ~ "Supplement use"))

desired_order <- c("Adequate intake", "High intake", "No supplement use", "Supplement use")
...
# ggsave("figures/SUPP_FIGURE5_revision.pdf", width = 18, height = 12)
