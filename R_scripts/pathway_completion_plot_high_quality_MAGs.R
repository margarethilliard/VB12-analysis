...
## Keeping this script in the repo although it doesn't have an output  
## in the manuscript. It was written based on reviewer comments. We did a 
## sensitivity analysis to see if using high-quality draft MAGs changed our 
...
res <- readr::read_delim("data/B12_biosynth-module_pathwise_completeness-MATRIX-high-quality-MAGs.txt") %>%
...
MAG_n <- readr::read_delim("/Users/local-margaret/Downloads/external_genomes_high_quality_v2.txt") %>% 
...
unique(data_merged$subject_id) # n=225 ?
...
#ggsave("figures/MAGs_Patchwork_reviewer_comments.pdf", width = 8, height = 5)
